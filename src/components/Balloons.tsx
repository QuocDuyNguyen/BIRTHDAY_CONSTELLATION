...
const balloons: BalloonSpec[] = [
  { color: "lilac", left: "5%", top: "22%", size: 82, delay: 0.05, duration: 1.05, rotate: -7 },
  { color: "blush", left: "15%", top: "52%", size: 68, delay: 0.28, duration: 1.2, rotate: 5 },
  { color: "cream", left: "27%", top: "12%", size: 52, delay: 0.48, duration: 1.1, rotate: -4 },
  { color: "berry", left: "73%", top: "43%", size: 74, delay: 0.18, duration: 1.16, rotate: 6 },
  { color: "lilac", left: "84%", top: "18%", size: 58, delay: 0.38, duration: 1.08, rotate: -5 },
  { color: "blush", left: "91%", top: "62%", size: 86, delay: 0.62, duration: 1.28, rotate: 7 },
